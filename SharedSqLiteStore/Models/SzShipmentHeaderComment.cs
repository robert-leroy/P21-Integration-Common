/*
 * File: SzShipmentHeaderComments.cs
 ...
 * 
 * Description:
 * This class is responsible defining the SzShipmentHeaderComments table structure.
 * Subzero sends these as record type "SC".
 * 
 * Dependencies:
...
[DelimitedRecord("|")]
[Table("SzShipmentHeaderComment")]
public class SzShipmentHeaderComment : SzBase
{
    ...
    {
        return String.Format("Header Comment | SZPTRID: {0} - INVNBR: {1} - INVSEQ: {2} - INVDTLSEQ: {3} - CMTSEQ: {4}", SZPTRID, INVNBR, INVSEQ, INVDTLSEQ, CMTSEQ);
    }
}
